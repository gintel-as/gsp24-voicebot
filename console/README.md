...
* To tailor the sample to your environment, use search and replace across the whole project to update the following strings:
  * `b16f6e70cac14487af395758c3db4e59`: replace with your subscription key.
  * `norwayeast`: replace with the [region](https://aka.ms/csspeech/region) your subscription is associated with.
  ...
  * The following settings apply for intent recognition powered by the [Language Understanding service (LUIS)](https://aka.ms/csspeech/luisdocs):
    * `b16f6e70cac14487af395758c3db4e59`: replace with your Language Understanding service subscription key (endpoint key).
    * `norwayeast`: replace with the region associated with your Language Understanding service subscription.
